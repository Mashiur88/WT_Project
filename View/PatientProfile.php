...
require_once ('../Control/patientinfo.php');
$data=patientdetails();
?>
...
<div class="row">
  <div class="col-xs-12 col-sm-9">
    <form class="form-horizontal" method="post" action="../Control/patientupdate.php" onsubmit="return validation()" enctype="multipart/form-data" >
