...
<section>
<form class="box" action="../Control/addven.php"onsubmit="return validation()" method="post">
		...
		function validation(){
      	...
      	var uid = document.getElementById('uname').value;
			...
			if(mobileNumber.length!=15){
				document.getElementById('error_message').innerHTML =" ** Account Number must be 15 digits only";
				return false;
			}
